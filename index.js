...
const TAG = '[serverless-httpapi-cloudfront]';

class ServerlessHttpApiCloudFrontPlugin {
  ...
  getConfig(field, defaultValue) {
    return _.get(
      this.serverless,
      `service.custom.httpApiCloudFront.${field}`,
      defaultValue,
    );
  }
}

module.exports = ServerlessHttpApiCloudFrontPlugin;
