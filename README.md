# serverless-httpapi-cloudfront

[![serverless](http://public.serverless.com/badges/v3.svg)](http://www.serverless.com)
[![npm version](https://badge.fury.io/js/serverless-httpapi-cloudfront.svg)](https://badge.fury.io/js/serverless-httpapi-cloudfront)
...
[![npm downloads](https://img.shields.io/npm/dt/serverless-httpapi-cloudfront.svg?style=flat)](https://www.npmjs.com/package/serverless-httpapi-cloudfront)

Automatically creates properly configured AWS CloudFront distribution that routes traffic
to AWS api gateway v2 (httpapi).

**:zap: Pros**

- Allows you to set-up custom domain for your http api gateway
...
```
$ npm install --save-dev serverless-httpapi-cloudfront
```

## Configuration

- All httpApiCloudFront configuration parameters are optional - e.g. don't provide ACM Certificate ARN
